...
import { Clock, Trash, User2 } from 'lucide-react'
                  ...
                  group-hover:opacity-30 transition-all duration-500"
                   ...
                   group-hover:to-purple-500/20 transition-all duration-500">
                                    ...
                                    <div className=' space-y-1'>
                                        ...
                                        <div className='flex items-center gap2 text-xs text-gray-500'>
                            ...
                            >
                                <StarButton snippetId={snippet._id} />
                                {
                                    user?.id === snippet.userId && (
                                        <div className='
                                            z-10' onClick={(e) => e.preventDefault()}>
                                            <button
                        ...
                        <div className='space-y-4'>
                            ...
                            <div className='relative group/code'> 
                                         <div className='absolute inset-0 bg-gradient-to-br from-blue-500/15 to-purple-500/5 rounded-lg opacity-0 
                                         group-hover/code:opacity-100 transition-all'>
                                            <pre className='relative bg-black/30 rounded-lg p-4 overflow-hidden
                                            text-sm text-gray-300 font-mono line-clamp-3
                                            '>
                                                {snippet.code}
                                            </pre>
                                         </div>
